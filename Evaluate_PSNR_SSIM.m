...
methods = {'R2R_NCS2_CASA2_SE_TRANSF6_S_X3'};
dataset = {'BSDS100'};
ext = {'*.jpg', '*.png', '*.bmp'};
    ...
    for idx_set = 1:num_set       
        ...
        for scale = scale_all
            ...
            for idx_im = 1:length(filepaths)
                ...
                if strcmp(dataset{idx_set},'urban100') == 1  
                    name_SR_1 = strrep(name_HR, '_HR_x3','');
                    name_SR = erase(name_SR_1,'_'); 
                else
                    name_SR = strrep(name_HR, '_HR_x3','');
                end
                
%                 name_SR = strrep(name_HR, '_HR_x2','x2');
